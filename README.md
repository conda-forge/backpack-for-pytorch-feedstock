...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/backpack-for-pytorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14407&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/backpack-for-pytorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `backpack-for-pytorch` can be installed with:

```
conda install backpack-for-pytorch
```

It is possible to list all of the versions of `backpack-for-pytorch` available on your platform with:
